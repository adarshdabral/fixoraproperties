...
import { roleHasPermission, type Permission } from "../shared/types/index.js";

/**
 * Checks the requesting user's role against the centralized
 * ROLE_PERMISSIONS map in src/shared/types/permissions.ts. This is the primary authorization
